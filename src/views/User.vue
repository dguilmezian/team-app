          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-6 col-md-12">
                ...
                <p>Birthdate: {{dateFormat(user.dateOfBirth)}}</p>
                <p>Phone Number: {{user.phone}}</p>
                <p>Address: {{user.location.street}}, {{user.location.city}}, {{user.location.state}}. {{user.location.country}}</p>
                <p>Register Date: {{dateFormat(user.registerDate)}}</p>
